...
import { StatiticsConsumer, StatiticsContex } from "../context/StatiticsContex";
const Statitics = () => {
          ...
          {(statitics) => (
            <>
              <StatiticsContainer>
                ...
                <CountTimes id="count-times">{statitics.hours}</CountTimes>
              </StatiticsContainer>
              <StatiticsContainer>
                <Response>
                  <Span>
