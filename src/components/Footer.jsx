...
import {FooterDiv, Icon, Ir, Path } from '../styles/styleFooter'
...
const Footer = () => {
    return (
        <FooterDiv id="footer">
            ...
            <Ir to="/statitics">
                <Icon className="icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <Path fillRule="evenodd" clipRule="evenodd"
